              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open('Production_controller/add_owners_login',['data-parsley-validate class'=>'form-horizontal form-label-left'])?>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Create Login id<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">

                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'user_id', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Create login id'])?>
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Create Password<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'Password', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Create password'])?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <?php echo form_submit(['class'=>'btn btn-success', 'type'=>'submit', 'value'=>'Create'])?>
                        </div>
                      </div>
