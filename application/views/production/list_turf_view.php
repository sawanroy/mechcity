                    ...
                    <table class="table table-striped projects">
                      <thead>
                        <tr>
                          ...
                          <th>Location</th>
                          <th>City</th>
                          <th style="width: 20%">Disciption</th>
                      ...
                      <?php foreach($c->result() as $user): ?>
                        <tr>
                          ...
                          <td>
                            <a><?php echo $user->Select_area?></a>
                            <br />
                            </td>
                            <td>
                            <a><?php echo $user->city?></a>
                            <br />
                            </td>
                            <td>
                            <a><?php echo $user->Disciption?></a>
                            <br />
                            </td>
                          ...
                          <td>
                          <?php  $usr_data=$user->sno;?>
                            <!-- <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a> -->
                            <i class="fa fa-pencil"><?= anchor("Production_controller/edit_turf/{$usr_data}",'edit',['class'=>'btn btn-info btn-xs' ,'fa fa-pencil' ])?></i>
                            <i class="fa fa-trash-o"><?= anchor("Production_controller/del_turf_show/{$usr_data}",'Delete',['class'=>'btn btn-danger btn-xs'])?></i>
