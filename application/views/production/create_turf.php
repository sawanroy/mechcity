              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('Production_controller/add_slots_turf',['data-parsley-validate class'=>'form-horizontal form-label-left'])?>
                      <!-- <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      </p>
                      <span class="section">Personal Info</span> -->

                      <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Select Turf<span class="required">*</span>
                        </label>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_input(['type'=>'time', 'required'=>'required','name'=>'start_time', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Turf address'])?>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input type="time" id="telephone" name="phone" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12"> -->
                          <?php echo form_input(['type'=>'time', 'required'=>'required','name'=>'End_time', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Turf address'])?>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_input(['type'=>'number', 'required'=>'required','name'=>'price', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Price'])?>
                        </div>
                      </div>
