                    ...
                    <table class="table table-striped projects">
                      ...
                      <?php foreach($c->result() as $user): ?>
                        <tr>
                          <td>#</td>
                          <td>
                          <a><?php echo $user->user_id?></a>
                          </td>
                          <td>
                            <a href="#" ><?php echo $user->Turf_Owner_Name?></a>
                            <br />
                          ...
                          <td>
                            <a><?php echo $user->Phone_Number?></a>
                            <br />
                            </td>
                            <td>
                            <a><?php echo $user->Email__Address?></a>
                            <br />
                            </td>
                            <td>
                            <a><?php echo $user->Turf_Location?></a>
                            <br />
                            </td>
                          ...
                          <td>
                          <?php  $usr_data=$user->id;
                          $usr_name=$user->Turf_Name;?>
                            <!-- <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a> -->
                            <i class="fa fa-pencil"><?= anchor("Production_controller/show_pwd/{$usr_name}",'Show',['class'=>'btn btn-info btn-xs' ,'fa fa-pencil' ])?></i>
                            <i class="fa fa-trash-o"><?= anchor("Production_controller/delete_turf/{$usr_data}",'Delete',['class'=>'btn btn-danger btn-xs'])?></i>
