              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('Production_controller/add_turf_details',['data-parsley-validate class'=>'form-horizontal form-label-left'])?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'Turf_Name', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Turf Name'])?>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'Select_area', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Area like  Thane, vashi, kalyan'])?>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'address', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Turf address'])?>
                        </div>
                      </div>
              <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Select city<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input type="text" id="number" name="number" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12"> -->
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'city', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter city'])?>
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Select state<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input type="text" id="number" name="number" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12"> -->
                          <?php echo form_input(['type'=>'text', 'required'=>'required','name'=>'state', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter State'])?>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo form_textarea(['type'=>'textarea', 'required'=>'required','name'=>'Disciption', 'class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Disciption'])?>
                        </div>
                      </div>
