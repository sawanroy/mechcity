...
<html lang="en">
  <head>
    ...
    <!-- FullCalendar -->
    <link href="<?= base_url('assets/production/vendors/fullcalendar/dist/fullcalendar.min.css')?>" rel="stylesheet">
    <link href="<?= base_url('assets/production/vendors/fullcalendar/dist/fullcalendar.print.css')?>" rel="stylesheet" media="print">
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Calendar <small>Click to add/Turfs events</small></h3>
              </div>
    ...
    <script src="<?= base_url('assets/production/vendors/fullcalendar/dist/fullcalendar.min.js')?>"></script>
