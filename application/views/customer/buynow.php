                ...
                <div class="row map-content-9">
                    <div class="col-lg-8">
                        <div class="contact-form">
                            <h5 class="mb-2">Buyer detail</h5>
                            <p class="mb-4">Need some details to book the turf</p>
                            <?php if(@count($d)): ?>
                           <?php foreach($d->result() as $slots): 
                            ...
                            endforeach;
                                ...
                                <?php echo form_open('Customer_controller/pay')?>
                                <div class="form-grid">
                                     <?php
                                   ...
                                   <input type="text" name="Fname" value="<?php echo $fname?>"id="Fname" placeholder="Full Name"
                                            required="">
                                           
                                    </div>
                                    <div class="input-field">
                                  
                                             <input type="text" name="Contact_number" id="Cnumber" placeholder="Contact Number"  required="">
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="price" value="<?=$price1  ?>" id="Email" placeholder="Email Address"
                                            required="">
                                        <input type="hidden" name="turf_sno" value="<?=$turf_sno  ?>" id="Email" placeholder="Email Address"
                                            required="">
                                            
                                    <label>Need a ball? Pick one</label><br>
                                <input type="checkbox"  name="ball" value="50"> <label>Nivia ball- 50/-</label><br>
                                    <input type="checkbox"  name="ball1" value="75"> <label>Adidas/puma - 75/- </label><br>
